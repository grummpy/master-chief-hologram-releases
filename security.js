...
function validateChatPayload(payload) { if (!payload || !PROVIDERS.includes(payload.provider)) throw new Error('Invalid provider selected.'); return { ...payload, messages: validateMessages(payload.messages), masterMode: payload.masterMode === true }; }
