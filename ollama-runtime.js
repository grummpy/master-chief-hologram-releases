...
const AGENT_TOOLS = Object.freeze([
  ...
  ,Object.freeze({ alias: 'research_public_web', id: 'research.public_web', description: 'Search public web sources through the local SearXNG metasearch service without automatically invoking a paid AI provider. Optional domains and freshness constrain retrieval.', properties: { query: { type: 'string', maxLength: 500 }, domains: { type: 'array', items: { type: 'string' }, maxItems: 10 }, freshness: { type: 'string', enum: ['day','week','month','year'] } }, required: ['query'] })
]);
