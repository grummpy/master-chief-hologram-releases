...
const AGENT_TOOLS = Object.freeze([
  ...
  Object.freeze({ alias: 'project_replace_text', id: 'project.replace_text', description: 'Replace one exact unique text block in one Master Chief project file.', properties: { path: { type: 'string' }, oldText: { type: 'string' }, newText: { type: 'string' } }, required: ['path', 'oldText', 'newText'] }),
