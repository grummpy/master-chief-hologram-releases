...
for (const token of ['id="app"', 'id="holoStage"', 'id="holoImg"', 'id="holoStatus"', 'id="micBtn"', 'id="sendBtn"', 'id="autocompleteList"', 'aria-live="polite"']) if (!html.includes(token)) fail(`index.html is missing ${token}`);
