...
const requiredFiles = ['main.js', 'preload.js', 'renderer.js', 'autocomplete.js', 'local-routing.js', 'artifact-links.js', 'microphone-access.js', 'security.js', 'credential-store.js', 'tool-registry.js', 'rag-index.js', 'build-info.json', 'assets/icon.png'];
