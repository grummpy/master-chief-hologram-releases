...
const requiredFiles = ['main.js', 'preload.js', 'renderer.js', 'three-scene.js', 'autocomplete.js', 'local-routing.js', 'local-ai-manifest.js', 'local-ai-manifest.json', 'local-ai-audit.js', 'artifact-links.js', 'microphone-access.js', 'security.js', 'credential-store.js', 'tool-registry.js', 'rag-index.js', 'build-info.json', 'assets/icon.png', 'assets/vendor/three.module.min.js', 'assets/characters/command-officer-reference-v1.png'];
