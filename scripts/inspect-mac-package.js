...
const requiredFiles = ['main.js', 'preload.js', 'renderer.js', 'three-scene.js', 'three-scene.bundle.js', 'autocomplete.js', 'local-routing.js', 'local-ai-manifest.js', 'local-ai-manifest.json', 'local-ai-audit.js', 'artifact-links.js', 'microphone-access.js', 'security.js', 'credential-store.js', 'tool-registry.js', 'rag-index.js', 'audio-production.js', 'huggingface-setup.js', 'document-generator.js', 'file-ingestion.js', 'productivity-artifacts.js', 'ollama-evaluator.js', 'build-info.json', 'LICENSE', 'assets/icon.png', 'assets/vendor/three.module.min.js', 'assets/vendor/three.core.min.js', 'assets/characters/command-officer-reference-v1.png', 'assets/characters/commander-nova-personal-v1.png'];
